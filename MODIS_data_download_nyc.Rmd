...
Here we will obtain US County Shapefile from [NYC Open Data]("https://data.cityofnewyork.us/City-Government/Borough-Boundaries/tqmj-j8zm") and utilize it to visualize previously agreed upon extent for MODIS data download.
...
#read in shapefile and transform
nyc_county_df <- st_read(temp_2) %>% st_transform(4326)
```
...
MODIStsp(gui             = FALSE,
         ...
         selprod         = 'Surf_Temp_Monthly_005dg (M*D11C3)',
         bandsel         = "LST_Day_CMG", # daily surface temp
         sensor = "Terra",
